...
{
	m_facing_direction = FACING_LEFT; //might be wrong direction check and experiment
	m_injured = false;
	Jump();
}
...
{
	Character::Update(deltatime, e);//not in the right place needs to be in base class?
